...
public:
    ...
    static std::vector<Array> Learn(std::vector<std::vector<float> > &vecs,
                                    int M, int Ks = 256);
    static std::vector<Array> Learn(std::vector<std::vector<float> > &vecs,
                                    int M, int Ks, long long N,
                                    vector<vector<int>>& labels);
    static std::vector<Array> Learn(const cv::Mat &vecs_cvmat, // a vec per row
                                    int M, int Ks = 256);
    static std::vector<PQ::Array> Learn(const cv::Mat &vecs_cvmat, int M, 
                            int Ks, long long N, vector<vector<int>>& labels);
